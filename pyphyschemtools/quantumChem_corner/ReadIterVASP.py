    	...
    	for line in outcarlines:
    		...
    		if re_energy.search(line):
    			...
    			if spinpolarized:
    				...
    				print ("%s  %s  %s  %s  %s  %s  %s  %s" % (stepstr,energystr,logdestr,iterstr,avgfstr,maxfstr,magstr,timestr))
    			else:
    				print ("%s  %s  %s  %s  %s  %s  %s" % (stepstr,energystr,logdestr,iterstr,avgfstr,maxfstr,timestr))
